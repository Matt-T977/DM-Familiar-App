                        ...
                        <Col lg={6} >
                            <Row className='justify-content-center mb-2'>
                                ...
                                style={{
                                    ...
                                    <Row>
                                        <Form.Check type='checkbox' label='Acrobatics' name='acrobatics' checked={character.acrobatics} placeholder='acrobatics' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Animal Handling' name='animal_handling' checked={character.animal_handling} placeholder='animal handling' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Arcana' name='arcana' checked={character.arcana} placeholder='arcana' />
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Athletics' name='athletics' checked={character.athletics} placeholder='athletics' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Deception' name='deception' checked={character.deception} placeholder='deception' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='History' name='history' checked={character.history} placeholder='history' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Insight' name='insight' checked={character.insight} placeholder='insight' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Intimidation' name='intimidation' checked={character.intimidation} placeholder='intimidation' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Investigation' name='investigation' checked={character.investigation} placeholder='investigation' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Medicine' name='medicine' checked={character.medicine} placeholder='medicine' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Nature' name='nature' checked={character.nature} placeholder='nature' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Perception' name='perception' checked={character.perception} placeholder='perception' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Performance' name='performance' checked={character.performance} placeholder='performance' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Persuasion' name='persuasion' checked={character.persuasion} placeholder='persuasion' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Religion' name='religion' checked={character.religion} placeholder='religion' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Sleight of Hand' name='sleight_of_hand' checked={character.sleight_of_hand} placeholder='sleight of hand' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Stealth' name='stealth' checked={character.stealth} placeholder='stealth' onChange={handleCheck}/>
                                    </Row>
                                    <Row>
                                        <Form.Check type='checkbox' label='Survival' name='survival' checked={character.survival} placeholder='survival' onChange={handleCheck}/>
                                    </Row>
                                </Col>
                            </Row>
